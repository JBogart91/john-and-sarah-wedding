...
const questions: AccordionItem[] = [
  ...
  },
  {
    ...
    data: 'Due to limited space at the venue, we are only able to accomodate those guests formally invited on the wedding invitation. Thank you for your understanding!',
    isOpen: false
  },
  {
    key: 3,
    title: 'Am I allowed to bring my children?',
    data: 'We love your little ones! However, we have decided to keep our wedding and reception an adult only event with the exception of nieces and nephews.',
    isOpen: false
  },
  {
    key: 4,
